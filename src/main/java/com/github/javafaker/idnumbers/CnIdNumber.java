...
public class CnIdNumber {
     ...
     * @return
     */
    public String cnEncoding(String str){
        String tem = str;
     ...
     * @return
     */
    public String getmainstr(Faker f) {
    ...
    public String getValidCn (Faker f){
        String mainstr = getmainstr(f);
        String cheakcode = cnEncoding(mainstr);
